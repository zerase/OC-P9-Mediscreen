...
public class AssessmentControllerTest {
    ...
    void getPatientAssessmentByPatientId_shouldReturnAssessmentForPatientWithTheGivenIdWithHttpStatus200Ok() throws Exception {
        ...
        when(assessmentService.assessDiabetesRiskLevelByPatientId(any(Integer.class))).thenReturn(assessmentDTO);

        MvcResult result = mockMvc.perform(get("/assess/{id}", patientId))
